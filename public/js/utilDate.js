...
// 年と月からDateオブジェクトを返す
export const getDate = (year, month) => new Date(year, month - 1);

// getPrviousMonthDate開始 -----------------------------------------
// ある月のDateオブジェクトを与えて先月のDateオブジェクトを求める
export const getPrviousMonthDate =
...
export const getBeginingOfTheWeek = (date) => {
...
export const getYMDString = (date) => `${getYearString(date)}-\
${getMonthString(date)}-\
${getDateString(date)}`;
...
export const getDateByWhatNumberDay =
