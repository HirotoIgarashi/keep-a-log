    ...
    io
      ...
      .on( 'connection', function ( socket ) {
        ...
        socket.on( 'createobject', function ( object ) {
          ...
          socket.emit( 'objectcreate', JSON.stringify( parse_data ) );
        });
        ...
        socket.on( 'readobject', function ( action_map ) {
          ...
          console.log( JSON.parse( action_map ) );
        ...
        socket.on( 'updateobject', function ( object ) {
          ...
          socket.emit( 'objectupdate', JSON.stringify( parse_data ) );
        });
        ...
        socket.on( 'deleteobject', function ( object ) {
          ...
          socket.emit( 'objectdelete', JSON.stringify( parse_data ) );
        });
